...
public class WebServiceClient {
    ...
    public static String CONTENT_TYPE_TEXT="application/text";
    ...
    public String doGet(String id)throws NetworkUnavailableException,Exception{
		try {
    ...
    public String getRequest(String id)
    	...
    	m_BaseUri = "http://dc.hashall.com/index.php/app/show/";
    	
        Log.i(tag, "Request : "+m_BaseUri);
        ...
        HttpGet get = new HttpGet(m_BaseUri+id);
    ...
    public String login(String username, String password)
		...
		try {
			...
			httpClient.getCredentialsProvider().setCredentials(
					new AuthScope(Constant.BASE_IP, 8080),
